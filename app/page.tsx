      ...
      <section className="flex p-10 mt-10">
        <div className="w-[65%] ">
          ...
          <h1 className="text-6xl text-white mt-6">
            I′m a <span className="text-transparent bg-gradient-to-r from-pink-500 to-violet-600 inline-block bg-clip-text"> Full Stack Developer </span> Based in <span className="text-transparent bg-gradient-to-r from-pink-500 to-violet-600 inline-block bg-clip-text">India.</span>
          </h1>
